...
return {
	...
	config = function()
		...
		require("possession").setup({
			...
			session_dir = vim.fn.stdpath("data") .. "/.vim/session",
			silent = false,
			load_silent = true,
			debug = false,
			logfile = false,
			...
			autosave = {
				...
				cwd = function() -- or fun(): boolean
					return true -- not require("possession.session").exists(require("possession.paths").cwd_session_name())
				end,
